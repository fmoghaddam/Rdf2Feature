...
public class Config {
    ...
    private static final Logger LOG = Logger
            .getLogger(Config.class.getSimpleName());
     ...
     *            to read the configuration for
     * @param defFloat
     *            default float value being returned, if no value is found
     * @return the according configured value; the default value, if nothing is
     *         configured for the provided key
     */
    public static float getFloat(
            final String key,
            final float defFloat)
    {
        try {
     ...
     *            to read the configuration for
     * @param defDouble
     *            default double value being returned, if no value is found
     * @return the according configured value; the default value, if nothing is
     *         configured for the provided key
     */
     ...
     *            default address value being returned, if no value is found
     * @return the according configured value; the default value, if nothing is
     *         configured for the provided key
     */
    ...
    /**
     * Returns an integer from the config.properties file expected to be an
     * address. Several notations may apply for an address:
     * <ul>
     * <li>plain integer
     * <li>hexadecimal notation beginning with '0x' or beginning with '0X'
     * <li>byte wise notation with bytes separated by '/', starting with the
     ...
     *            to read the configuration for
     * @param defaultAddress
     *            default address being returned, if no value is found
     * @return the according configured value; the default value, if nothing is
     *         configured for the provided key
     */
    public static int getAddress(
